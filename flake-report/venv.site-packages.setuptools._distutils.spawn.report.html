...
<html>
   <head>
      <title>flake8 violations: .\venv\site-packages\setuptools\_distutils\spawn.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.site-packages.setuptools._distutils.spawn.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .\venv\site-packages\setuptools\_distutils\spawn.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.site-packages.setuptools._distutils.spawn.source.html#l74">
